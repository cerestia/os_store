...
#define ISDIR(m) (((m)&IFMT) == IFDIR)   // 是常规文件
...
#define IRWXO 00007 // 其他人读、写、执行/搜索许可 0x111
#define IROTH 00004 // 其他人读许可 0x100
#define IWOTH 00002 // 其他人写许可 0x010
#define IXOTH 00001 // 其他人执行/搜索许可 0x001
